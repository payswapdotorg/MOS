...
| MKT-015, MKT-025 | IN FLIGHT | Worker sessions active (mkt-015c recreated after capacity rollback stripped agent mode; mkt-25 work held in session context, sandbox/redirect recovery in progress). |
