...
| MKT-015, MKT-020 | IN FLIGHT | mkt-015g: fresh dispatch live (GLM-5.3, agents tab, Full-Stack; base c4edcf2, migration 019 reserved). mkt-020: worker branch mkt/020-worker-delivery (8287b38, base ce89c06) pushed; Tech Lead merged onto current main (field-agents + logical agents coexist) — full verification in progress, then PR. |
