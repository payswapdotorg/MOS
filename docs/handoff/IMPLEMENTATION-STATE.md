...
| MKT-015 | IN FLIGHT | fresh dispatch mkt-015h (chat d319e357) after the site destroyed the queued session during the freeze; generating since 06:40Z. |
| MKT-031 | IN FLIGHT | worker session mkt-031b (chat fc11e689) dispatched 06:53Z after a CDP-timeout retry. |
