...
| MKT-015, MKT-020 | IN FLIGHT | mkt-020: capacity-recovery daemon assaulting create (8h autonomy). MKT-015: re-dispatch queued (session rollbacks voided two attempts). |
