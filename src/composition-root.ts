...
function buildCore(config: AppConfig, options: AppOptions): Core {
  ...
  return {
    ...
    modules: { users, auth, agencies, clients, workspaces, credentials, audit, goals, playbooks, workflows, executions, evidence, metrics: metricsModule, experiments, aiRuntime, fieldAgents, jobs, agents, policies },
  };
}
