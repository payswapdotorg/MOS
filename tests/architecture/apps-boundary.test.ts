...
test('MKT-047 provision: the checker enforces /apps with an EMPTY matrix allowance; the spec-parsed set stays 28', () => {
  ...
  // by the MKT-041 delivery) — both per the disclosed promotion
  ...
  assert.equal(specModules.length, 28);
